...
exports.BlockerService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let BlockerService = class BlockerService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(createBlockerDto) {
...
exports.BlockerService = BlockerService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], BlockerService);
//# sourceMappingURL=blocker.service.js.map